...
**3.15 MB** · free on the App Store · MIT ·
...
- **3.15 MB, and a window on screen in half a second.** Krita is a gigabyte and
...
| **Download** | 3.15 MB for the disk image, with a SHA-256 in `checksums.txt` |
